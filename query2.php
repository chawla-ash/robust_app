...
<div class="card-panel hoverable">
 ...
 <table id="address">
      ...
      <tr>
        ...
        <td class="wideField" colspan="3"><input class="field" name="lat" id="lattitude" ></input></td>
      </tr>

      <tr>
        <td class="label">Long</td>
        <td class="wideField" colspan="3"><input class="field" name="long" id="longitude" ></input></td>
      </tr>
    </table>
